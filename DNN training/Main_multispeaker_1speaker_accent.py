    ...
    while (epoch < training_epochs):
        ...
        for model in range(0,total_speakers):
            ...
            if not train_data.is_finish():
                ...
                #thistrain_valid_loss #, " Time Spent : ",(sub_end_time - sub_start_time)
...
#plt.plot(vector_1,'b-o',vector_2,'k-^',linewidth=2.0)
#plt.legend(handler_map={speaker1: HandlerLine2D(numpoints=1)})


plt.subplot(212)
plt.title('Multi-speaker model with 1 Scottish accent speaker',fontsize=14)
plt.xlabel('Epoch')
plt.ylabel('RMSE')
plt.grid(True)

...
io_train_list, io_test_list, train_speaker_ID, test_speaker_ID = make_train_test_list(80,20,1,speaker_accent = 'Scottish')

# <codecell>

best_validation_loss = train_DNN(io_train_list,io_test_list,n_ins=601,n_outs =259,n_speakers = 1, buffer_size = 5000, plot = False)

...
io_train_list_1, io_test_list_1, train_speaker_ID_1, test_speaker_ID_1 = make_train_test_list(80,20,n_speakers_accent= 1, speaker_accent = 'English')

io_train_list_2, io_test_list_2, train_speaker_ID_2, test_speaker_ID_2 = make_train_test_list(80,20,n_speakers_accent= 1, speaker_accent = 'Scottish')
...
plt.figure(1)
plt.subplot(211)
plt.title('Multi-speaker model with 1 English accent speaker',fontsize=14)
plt.xlabel('Epoch')
plt.ylabel('RMSE')
plt.grid(True)
...
plt.subplot(212)
plt.title('Multi-speaker model with 1 Scottish accent speakers',fontsize=14)
plt.xlabel('Epoch')
plt.ylabel('RMSE')
plt.grid(True)
speaker1, = plt.plot(vector_2,label = 'Speaker 1',linestyle = '-',marker='^',markersize=7,linewidth=2.0)

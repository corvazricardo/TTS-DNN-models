...
io_train_list_1, io_test_list_1, train_speaker_ID_1, test_speaker_ID_1 = make_train_test_list(80,20,n_speakers_accent= 4, speaker_accent = 'English')

io_train_list_2, io_test_list_2, train_speaker_ID_2, test_speaker_ID_2 = make_train_test_list(80,20,n_speakers_accent= 4, speaker_accent = 'Scottish')

    ...
    while (epoch < training_epochs):
        ...
        for model in range(0,total_speakers):
            ...
            if not train_data.is_finish():
                ...
                #if this_validation_loss < dnn_model.best_validation_loss:
                    ...
                    for speaker in range(0,total_speakers):
                        ...
                        if speaker < len(speakers_data_1):
                            ...
                            for state in range(0,size_shared,2):
                                ...
                                W_average = W_new/total_speakers
                                dnn_models_1[str(speaker)].params[state].set_value(W_average)
                            ...
                            for state in range(0,size_accent,2):
                                ...
                                W_average = W_new/total_speakers
                                dnn_models_2[str(speaker)].params[state].set_value(W_average)
                            ...
                            for state in range(0,size_accent,2):
                                ...
                                W_average = W_new/total_speakers
                                dnn_models_1[str(speaker-len(speakers_data_1))].params[state].set_value(W_average)
                            ...
                            for state in range(0,size_shared,2):
                                ...
                                W_average = W_new/total_speakers
                                dnn_models_2[str(speaker-len(speakers_data_1))].params[state].set_value(W_average)
...
io_train_list_1, io_test_list_1, train_speaker_ID_1, test_speaker_ID_1 = make_train_test_list(80,20,n_speakers_accent= 3, speaker_accent = 'English')

io_train_list_2, io_test_list_2, train_speaker_ID_2, test_speaker_ID_2 = make_train_test_list(80,20,n_speakers_accent= 3, speaker_accent = 'Scottish')
...
plt.figure(1)
plt.subplot(211)
plt.title('Multi-speaker model with 3 English accent speakers',fontsize=14)
plt.xlabel('Epoch')
plt.ylabel('RMSE')
plt.grid(True)
...
plt.ylabel('RMSE')
plt.grid(True)
speaker1, = plt.plot(vector_4,label = 'Speaker 1',linestyle = '-',marker='^',markersize=7,linewidth=2.0)
speaker2, = plt.plot(vector_5,label = 'Speaker 2',linestyle = '-',marker='o',markersize=7,linewidth=2.0)
speaker3, = plt.plot(vector_6,label = 'Speaker 3',linestyle = '-',marker='o',markersize=7,linewidth=2.0)

plt.legend(handler_map={speaker1: HandlerLine2D(numpoints=1)},prop={'size':9},loc='upper right')
plt.show()
